...
import bgimage from "../assets/bgpattern.svg"
  ...
  return (
    ...
    <div className={classes.container}>
      <div style={{zIndex:"10"}} className={classes.content}>
          <h1 style={{fontWeight:"600",fontFamily:"'Montserrat', sans-serif"}}>Hi, I'm Arun<img className={classes.wave} src={wave}/></h1>
      ...
      <div className={classes.imgcontainer}>
          <img style={{textAlign:"center"}} className={classes.bg} src={coder}/>
      </div>
  </div>
    </>
  )
