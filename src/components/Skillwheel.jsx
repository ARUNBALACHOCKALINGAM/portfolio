  ...
  return (
    ...
    <div className={classes.wheelcontainer}>
      ...
      <div className={classes.skilltoggle}>
        <ArrowLeftIcon onClick={handlePrev} style={{width:"60px",height:"60px",marginLeft:"50px",position:"relative",left:"10px"}}/>
       <h1 className={classes.skilltogglename} style={{minWidth:"135px",fontWeight:"400",fontSize:"1.375rem",display:"inline-block",whiteSpace:"nowrap",textAlign:"center"}}>{skill}</h1>
       <ArrowRightIcon onClick={handleNext} style={{width:"60px",height:"60px",marginLeft:"0px",position:"relative",left:"-10px"}}/>
      </div>
      </div>
